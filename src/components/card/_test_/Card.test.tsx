...
test('Check Image', () => {
  render(
    <ImageComponent src="https://i.scdn.co/image/ab67616d00001e02c5716278abba6a103ad13aa7" />
  );
  const trackCover = screen.getByRole('img');
  expect(trackCover).toBeInTheDocument;
  expect(trackCover).toHaveAttribute(
    'src',
    'https://i.scdn.co/image/ab67616d00001e02c5716278abba6a103ad13aa7'
  );
});
...
test('Check Button', () => {
  render(
    <ButtonComponent
      selected={
        'spotify:track:3dPtXHP0oXQ4HCWHsOA9js' ===
        'spotify:track:3dPtXHP0oXQ4HCWHsOA9js'
      }
      onSelect={() => ''}
      onDeselect={() => ''}
